...
export const voiceMakerVoice = {
    "en-US": ["ai1-Ivy", "ai1-Joanna", "ai1-Kendra", "ai1-Kimberly", "ai1-Salli", "ai1-Joey", "ai1-Justin", "ai1-Kevin", "ai1-Matthew", "ai2-John", "ai2-Stacy", "ai2-Nikola", "ai2-Scott", "ai2-Katie", "ai2-Scarlet", "ai2-Kathy", "ai2-Isabella", "ai2-Robert", "ai2-Jerry", "ai3-Jony", "ai3-Aria", "ai3-Jenny", "ai3-Nova", "ai3-Olive", "ai3-Taylor", "ai3-Vienna", "ai3-Kailey", "ai3-Addyson", "ai3-Emily", "ai3-Gary", "ai3-Kingsley", "ai3-Jason", "ai3-Evanai4-Sophia", "ai4-Amanda", "ai4-Edward", "ai4-Ronald", "ai4-Samantha", "ai4-Roger", "ai4-Doris"] as const,
    "en-GB": ["ai1-Amy", "ai1-Emma", "ai1-Brian", "ai2-Emily", "ai2-Jessica", "ai2-William", "ai2-Freddie", "ai2-Victoria", "ai3-Libby", "ai3-Mia", "ai3-Ryana", "i4-Elizabeth", "ai4-Harry", "ai4-Niamh"] as const,
    ...
    "nl-NL": ["ai2-nl-NL-Sterre", "ai2-nl-NL-Gerben", "ai2-nl-NL-Rogier", "ai2-nl-NL-Arenda", "ai2-nl-NL-Roosje", "ai3-nl-NL-Colette", "ai3-nl-NL-Fenna", "ai3-nl-NL-Maarten"] as const,
    "nl-BE": ["ai3-nl-BE-Marit", "ai3-nl-BE-Aldert"] as const,
    "en-CA": ["ai3-en-CA-Clara", "ai3-en-CA-Liam"] as const,
    "en-IN": ["ai2-en-IN-Alisha", "ai2-en-IN-Luv", "ai2-en-IN-Rohan", "ai2-en-IN-Tanvi", "ai3-en-IN-Neerja", "ai3-en-IN-Prabhas"] as const,
    ...
    "fi-FI": ["ai2-fi-FI-Karoliina", "ai3-fi-FI-Noora", "ai3-fi-FI-Selma", "ai3-fi-FI-Harri"] as const,
    "fr-BE": ["ai3-fr-BE-Leonie", "ai3-fr-BE-Gabriel"] as const,
    "fr-FR": ["ai2-fr-FR-Amandine", "ai2-fr-FR-Dylan", "ai2-fr-FR-Valentine", "ai2-fr-FR-Erwan", "ai2-fr-FR-Cassandra", "ai3-fr-FR-Denise", "ai3-fr-FR-Henri", "ai4-fr-FR-Chance", "ai4-fr-FR-Blaise"] as const,
    ...
    "pt-PT": ["ai2-pt-PT-Margarida", "ai2-pt-PT-Diogo", "ai2-pt-PT-Gabriel", "ai2-pt-PT-Ines", "ai3-pt-PT-Fernanda", "ai3-pt-PT-Raquel", "ai3-pt-PT-Duarte"] as const,
    ...
    "uk-UA": ["ai2-uk-UA-Aleksandra", "ai3-uk-UA-Olena", "ai3-uk-UA-Pavlo"] as const,
